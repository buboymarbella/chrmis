  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>INDGIGENOUS GROUP MEMBER</h1>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            <div class="card-header">
			  ...
			  <div class="card-tools">
            <form action="/print_demog_result_ig" method="POST" enctype="multipart/form-data" target="_blank">
                @csrf
            ...
            <div class="card-body">
				...
				<table id="example1" class="table table-head-fixed text-nowrap text-center">
					...
					<tr>
						<th>Civ HR Non-indigenous Member</th>
						<td>{{$indigenous_no}}</td>
					</tr>
					
					<tr>
						<th>Civ HR Indigenous Member</th>
						<td>{{$indigenous}}</td>
					</tr>
...
@if(empty($demographics_ig))
		<p></p>
	@else
		{{ $demographics_ig->script()}}
	@endif
