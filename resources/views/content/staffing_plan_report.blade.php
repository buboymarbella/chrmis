        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Staffing Plan Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
				...
				<table id="example1" class="table table-head-fixed text-nowrap text-center">
					<tr>
						...
						<th>Vacant 2st Level</th>
						<th>Total</th>
					</tr>
					<tr>
						<th><a href="{{route('staffing_office_plan','COORDINATING_STAFF')}}">Joint Staff Wide</a></th>
            ...
            <td>{{ $plantilla_jsw_1st + $plantilla_jsw_2nd}}</td>
					...
					<tr>
						<th><a href="{{route('staffing_office_plan','PERSONAL_STAFF')}}">Personal Staff Wide</a></th>
            ...
            <td>{{ $plantilla_pers_1st + $plantilla_pers_2nd }}</td>
					...
					<tr>
						<th><a href="{{route('staffing_office_plan','SPECIAL_STAFF')}}">Special Staff Wide</a></th>
          ...
          <tr>
						<th><a href="{{route('staffing_office_plan','UNIFIED_COMMAND')}}">Unified Commands</a></th>
          ...
          <tr>
						<th><a href="{{route('staffing_office_plan','AFPWSSUS')}}">AFPWSSU's</a></th>
