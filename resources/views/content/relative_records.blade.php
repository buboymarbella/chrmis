    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('relatives.store') }}"  enctype="multipart/form-data">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-4">
					<p style="padding-top:5px;">Relationship</p>
					<input type="text" name="relationship" placeholder="Relationship" class="form-control input" value="{{ old('occupation_address') }}"/>
				</div>
							
				<div class="col-md-12">
					<p style="padding-top:5px;">Present Address</p>
					<input type="text" name="address" placeholder="Present Address" class="form-control input" value="{{ old('present_address') }}"/>
				</div>
