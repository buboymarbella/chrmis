  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="float-left my-2">Showing {{ $year_count }} entries</div>
				
				<div class="float-right  pb-1">
					
            <form action="/download_demog_result_yb" method="POST" enctype="multipart/form-data" target="_blank">
                @csrf
                ...
                <input type="text" name="date_dob" value="{{ $date_dob }}" hidden>
            </form>
				</div>
