    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-4">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('awards_demog_report') }}"  enctype="multipart/form-data">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12" id="year_birth">
					...
					<div class="input-group">
						...
						<input type="text" name="year" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy" data-mask>
					</div>
                </div>
