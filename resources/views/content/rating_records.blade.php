      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
			...
			<div style="float:right"> <a href="{{ route('rating', $master->main_id)}}"><button type="button" class="btn btn-warning btn-sm text-light">BACK TO PROFILE</button></a></div>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content col-md-6">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('ratings.store') }}"  enctype="multipart/form-data">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12">
					...
					<input required type="text" id="search" name="n_rating"  placeholder="Numerical Ratings" class="form-control input" onChange="myFunction()"
						onKeyPress="return disableEnterKey(event)"	value=""/>
				</div>
