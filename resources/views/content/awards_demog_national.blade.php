  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>NATIONAL AWARDS YEAR "{{ $date_commendation}}"</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
				...
				<div class="float-right pb-2">
					<form action="{{ route('download_national_award') }}" method="POST" enctype="multipart/form-data" target="_blank">
					@csrf
          ...
          <tbody>
				...
				<div class="float-left my-2">Showing 1 to 20 of {{ $national_awards_count }} entries</div>
				<div class="float-right">
					{{ $national_awards->appends(['national_awards' => $national_awards->currentPage(), 'search_sp_case_op' => request()->search, 'per_page' => request()->per_page])->links() }}
				</div>
            </div>
            <!-- /.card-body -->
          </div>
