    ...
    <section class="content col-md-8">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('colleges.store') }}"  enctype="multipart/form-data" />
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12" >
					...
					<input autocomplete="off" type="text" class="form-control input" name="college"  placeholder="Name of School" value="{{ old('college') }}"/>
				</div>
				...
				<div class="col-md-4" >
					...
					<input type="number" name="year_required" placeholder="Required Year/s" class="form-control input" value="{{ old('year_required') }}"/>
				</div>
