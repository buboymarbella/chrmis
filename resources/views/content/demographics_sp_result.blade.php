        ...
        <div class="col-md-6">
          ...
          <div class="card">
            <div class="card-header">
			  ...
			  <div class="card-tools">
            <form action="/print_demog_result_sp" method="POST" enctype="multipart/form-data" target="_blank">
                @csrf
            ...
            <div class="card-body">
				...
				<table id="example1" class="table table-head-fixed text-nowrap text-center">
					...
					<tr>
						<th>Civ HR Solo Parent </th>
						<td>{{ $solo }}</td>
					</tr>
					
					<tr>
						<th>Civ HR Non-Solo Parent</th>
						<td>{{ $solo_no }}</td>
					</tr>
				</table>
				</div>
...
@if(empty($demographics_solo))
		<p></p>
@else
		{{ $demographics_solo->script()}}
@endif
@endpush
