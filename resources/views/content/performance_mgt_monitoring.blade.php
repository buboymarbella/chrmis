...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>PERFORMANCE MGT MONITORING REPORT</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-4">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('performance_mgt_monitoring_report') }}" target="_blank" enctype="multipart/form-data">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12">
					...
					<select id="select-dropdown"  class=" form-control select2" name="office">
