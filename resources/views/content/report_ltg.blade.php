    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('print_ltg') }}"  enctype="multipart/form-data" target="_blank">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-4">
					...
					<select id="reg" class="form-control input" name="view_all">
