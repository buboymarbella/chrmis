    ...
    <section class="content col-md-8 ">
      <div class="container-fluid ">
        ...
        <div class="card card-default ">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('vocationals.store') }}"  enctype="multipart/form-data" />
			@csrf
          <div class="card-body ">
            <div class="row">
				...
				<div class="col-md-12" >
					...
					<input autocomplete="off" type="text" class="form-control input" name="vocational"  placeholder="Name of School" value="{{ old('vocational') }}"/>
				</div>
