      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <div style="float:right"> <a href="{{ route('families_records', $master->main_id)}}"><button type="button" class="btn btn-warning btn-sm text-light">BACK TO PROFILE</button></a></div>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-6">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('childrens.store') }}"  enctype="multipart/form-data">
			@csrf
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-8" id="data_1">
					...
					<input type="text" name="child_name"  placeholder="Complete Name" class="form-control input"  value="{{ old('child_name') }}"/>
				</div>
