...
<body>
	<div style="width:100%;text-align:right;font-size:12px">
		...
		<div style="width:100%;text-align:left;padding:0px 0px 0px 0px;">
			<h3 style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;border-bottom:1px solid black;">CPBC</h3>
		</div>
		...
		<table style="width:100%;padding:0px 0px 0px 0px;">
			<tr>
				...
				<th height="20"  style="border-left:0px;border-rigth:0px; border-top:1px solid black; border-bottom:1px solid black;width:100px;">DATE CPORT</th>
			</tr>
			...
			<tr>
				...
				<td style="border:0px;text-align:center;font-family:normal;">{{ $master->inclusive_to == null ? 'N/A' : date("m/d/Y", strtotime($master->inclusive_to)) }}</td>
			</tr>
			@empty
			<tr>
