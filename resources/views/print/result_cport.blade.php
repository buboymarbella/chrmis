  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
	  <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>TRAINING MATRIX CPORT</h1>
          </div>
          <div class="col-sm-6">
            <div style="float:right"> <a href="{{ route('training_matrix') }}"><button type="button" class="btn btn-warning btn-sm text-light">BACK TRAINING MATRIX</button></a></div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <a href="{{ route('training_cport')}}" class="btn btn-sm btn-default btn-flat pull-right my-1" target="_blank"> 
                ...
                <thead>
					<tr>
						...
						<th style="width:10%;">Date of Appt</th>
						<th style="width:10%;">TARGET BATCH FOR CPORT</th>
					</tr>
                </thead>
                <tbody>
					...
					<tr>
						...
						<td>{{ $master->date_hired == null ? 'N/A' : date("m/d/Y", strtotime($master->date_hired)) }}</td>
						<td>N/A</td>
					</tr>
					@empty
						<tr>
