...
<body>
	<div style="width:100%;text-align:right;font-size:12px">
		...
		<div style="width:100%;text-align:left;padding:0px 0px 0px 0px;">
			<h3 style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;border-bottom:1px solid black;">CPASC</h3>
		</div>
		
		<table style="padding:0px 0px 0px 0px;">
			<tr>
				<th height="20" style="border-left:0px;border-rigth:0px; border-top:1px solid black; border-bottom:1px solid black;width:50px;">NR</th>
				...
				<th height="20"  style="border-left:0px;border-rigth:0px; border-top:1px solid black; border-bottom:1px solid black;width:100px;">DATE OF CPBSC</th>
			</tr>
			...
			<tr>
				...
				<td style="border:0px;text-align:center;font-family:normal;word-wrap: break-word;">{{ $master->cpbsc_date == null ? 'N/A' : date("m/d/Y", strtotime($master->cpbsc_date)) }}</td>
			</tr>
			@empty
				<tr>
