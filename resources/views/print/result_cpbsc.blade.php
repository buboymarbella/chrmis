    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <a href="{{ route('training_cpbsc')}}" class="btn btn-sm btn-default btn-flat pull-right my-1" target="_blank"> 
                ...
                <thead>
					<tr>
						...
						<th style="width:10%;">Date of CPBC</th>
						<th style="width:10%;">Num Rating For The Last Sem</th>
					</tr>
                </thead>
                <tbody>
					...
					<tr>
						...
						<td>{{ $master->cpbc_date == null ? 'N/A' : date("m/d/Y", strtotime($master->cpbc_date)) }}</td>
						<td>{{ $master->n_rating == null ? 'N/A' :  $master->n_rating }} </td>
					</tr>
					@empty
						<tr>
