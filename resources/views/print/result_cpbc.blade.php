    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          ...
          <a href="{{ route('training_cpbc')}}" class="btn btn-sm btn-default btn-flat pull-right my-1" target="_blank"> 
				...
				<table id="example1" style="width:100%" class="table table-head-fixed text-nowrap text-center">
                <thead>
                ...
                <tbody>
					...
					<tr>
						...
						<td>{{ $master->inclusive_to == null ? 'N/A' : date("m/d/Y", strtotime($master->inclusive_to)) }}</td>
					</tr>
					@empty
						<tr>
