        ...
        <div class="row mb-2">
          <div class="col-md-6">
            <div style="float:left"><h1>Reference</h1></div>
			      <div style="float:right"> <a href="{{ route('reference', $masters->master_id)}}"><button type="button" class="btn btn-warning btn-sm text-light">BACK TO PROFILE</button></a></div>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-6">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('references.update',$masters->id) }}"  enctype="multipart/form-data">
			@csrf
			@method('PUT')
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12" id="data_1">
					...
					value="{{ $masters->name == null ? '' : $masters->name }}"/>
				</div>		
				<div class="col-md-12" id="data_1">
					...
					value="{{ $masters->telephone_no == null ? '' : $masters->telephone_no }}"/>
				</div>
				...
				<div class="col-md-12" id="data_1">
					...
					value="{{ $masters->address == null ? '' : $masters->address }}"/>
				</div>
