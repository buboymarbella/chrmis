    ...
    <section class="content col-md-8">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('graduates.update',$masters->id) }}"  enctype="multipart/form-data" />
			@csrf
			@method('PUT')
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12" >
					...
					<input autocomplete="off" type="text" class="form-control input" name="graduate"  placeholder="Name of School" value="{{ $masters->name_school== null ? '' : $masters->name_school }}"/>
				</div>
				...
				<div class="col-md-4" id="data_1">
					...
					<!--<input type="text" name="emp_stat"  placeholder="Employee Status" class="form-control input"  value="{{ old('emp_stat') }}"/>-->
					 <select name="type_of_schooling" class="form-control" >
						<option>{{ $masters->type_schooling== null ? '' : $masters->type_schooling }}</option>	
