      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
			...
			<div style="float:right"> <a href="{{ route('issued', $masters->master_id)}}"><button type="button" class="btn btn-warning btn-sm text-light">BACK TO PROFILE</button></a></div>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default col-md-6">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('issues.update',$masters->id) }}"  enctype="multipart/form-data">
			@csrf
			@method('PUT')
          <div class="card-body">
            <div class="row">
				...
				<div class="col-md-12" >
					...
					required value="{{ $masters->gov_issue == null ? '' : $masters->gov_issue }}"/>
				</div>			                       
				...
				<div class="col-md-12">
					<p style="padding-top:5px;">Date/Place of IssuancePlace of Issuance</p>
					<input autocomplete="off"  type="text" name="place_issue"  placeholder="Place of Issuance" class="form-control input" 
					value="{{ $masters->place_issue == null ? '' : $masters->place_issue }}"/>
				</div>
				<!--
				<div class="col-md-12" id="data_1">
					...
					<div class="input-group">
						...
						value="{{ $masters->date_issue == null ? 'mm/dd/yyyy' : $masters->date_issue }}" />
					</div>
                </div>
				-->
				</div>
