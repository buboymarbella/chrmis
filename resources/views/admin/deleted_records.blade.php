          ...
          <div class="card">
            ...
            <div class="card-body">
		  	...
		  	<div class="float-right">
					<form class="form-inline ml-0" method="POST" action="{{ route('search_deleted_chr') }}">
						@csrf
						@method('GET')
                ...
                <tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="{{ route('restore_delete_record', $master->id) }}" >
							<button style="display:inline;border:0;" type="submit" class="btn btn-primary btn-sm" title="Restore">
							<i class="fas fa-undo"></i>
							</button>
							</a>
							<a href="{{ route('permanent_delete_record', $master->id) }}" onclick="return confirm('Are you sure you to delete the record?')">
							<button style="display:inline;border:0;" type="submit" class="btn btn-danger btn-sm" title="Delete">
